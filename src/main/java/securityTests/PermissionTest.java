...
public class PermissionTest
{
   public static void main(String[] args) throws URISyntaxException {
      System.out.println(URI.create("PermissionTest.policy"));
      URL systemResource = ClassLoader.getSystemResource("PermissionTest.policy");
      String s = systemResource.toURI().toString();
      System.out.println(s);
      System.setProperty("java.security.policy", s);
